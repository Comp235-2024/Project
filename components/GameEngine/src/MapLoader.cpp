 ...
 */
void MapLoader::calculateTextureSizes(int x, int y) {
...
void MapLoader::handleCloseEvent() {
 ...
 * @param event
 */
void MapLoader::handleMouseButtonPressedEvent(const sf::Event& event) {
 ...
 * @param mousePos
 */
void MapLoader::processClickActions(const sf::Vector2f& mousePos) {
 ...
 * @param mousePos
 */
void MapLoader::placeObjectOnMap(const sf::Vector2f& mousePos) {
 ...
 * @param mousePos
 */
void MapLoader::selectObjectFromSidebar(const sf::Vector2f& mousePos) {
    try {
...
void MapLoader::initSideBar() {
    ...
    for (const string& itemName : itemNames) {
        ...
        MapLoader::SidebarItem sidebarObject= SidebarItem(*item_name, maxnb);
...
MapLoader::SidebarItem::SidebarItem(const string &name, const int permittedCount) {
    this->name = name;
