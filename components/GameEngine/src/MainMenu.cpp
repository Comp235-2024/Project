...
void MainMenu::SetButtons() {
    ...
    GenerateButton(font, "Options", buttons->options, buttons->optionsText, position + Vector2f(0, 500));
    GenerateButton(font, "Quit", buttons->quit, buttons->quitText, position + Vector2f(0, 600));
