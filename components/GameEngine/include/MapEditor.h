...
#ifndef A2_MAPEDITOR_H
#define A2_MAPEDITOR_H
...
public:
    ...
    */
   explicit MapEditor(MainDataRef data);
...
private:
    ...
    */
   struct Buttons {
       RectangleShape CreateMap; ///< The play button.
       Text CreateMapText; ///< The text on the play button.
       RectangleShape LoadMap; ///< The edit map button.
       Text LoadMapText; ///< The text on the edit map button.
   };
