...
* @date 22-Mar-2024
*/
#ifndef A3_GAMESCREENType_H
#define A3_GAMESCREENType_H
...
*/
class GameScreenType : public State {
...
public:
    ...
    */
   explicit GameScreenType(MainDataRef data, const std::string& characterType);
